...
<div class="panel">
  ...
  <p>
    ...
    <br>
    Yandaki alandan, Bayi adı, bayi kodu, api kullanıcı adı ve şifenizi yazdıktan sonra, isteğe bağlı olarak test modunu
...
<div class="panel">
  <p>
    ...
    <br>
    Taksit tablosunu temanızın ya da içeriklerinizin istediğiniz alanında, <strong>[moka-taksit-tablosu]</strong> veya
    <strong>[moka-installment-table]</strong> kısa kodu ile gösterebilirsiniz.
  </p>
</div>
...
<a href="https://github.com/optimisthub/moka-woocommerce">
  <img
    src="https://img.shields.io/github/last-commit/optimisthub/moka-woocommerce?label=Recent%20Update&style=for-the-badge&logo=github"
    alt="">
</a>

<hr>
<br>
<a href="https://optimisthub.com/?utm_source=moka-woocommerce&utm_campaign=moka-woocommerce&utm_content=<?php echo get_bloginfo("wpurl"); ?>"
  target="_blank">
  <img style="width:220px" src="<?php echo OPTIMISTHUB_MOKA_URL.'assets/img/optimisthub.svg'; ?>" alt="">
</a>
